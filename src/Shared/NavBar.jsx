...
const NavBar = () => {
  ...
  const navLink = (
    <>
      ...
      <li>
        {role === "user" && <NavLink to={"/dashboard/user"}>Dashboard</NavLink>}
        {role === "agent" && (
            ...
            <div className="flex items-center text-2xl gap-3">
              ...
              <div className="flex items-center gap-4">
                <div className="relative cursor-pointer">
                  <SlHandbag />
                  <div className="absolute text-sm -top-2 -right-2 z-10 bg-[#00B207] rounded-full size-5 text-white flex justify-center items-center">
                    5
                  </div>
                </div>
