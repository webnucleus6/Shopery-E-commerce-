        ...
        <div className='grid lg:grid-cols-3 gap-6'>
            ...
            <div className='first-banner text-white space-y-7 md:col-span-2 row-span-2' >
                ...
                <div className='space-y-7'>
                    ...
                    <a href="#_" class="font-bold inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg text-[#00b207] bg-white rounded-full  sm:w-auto sm:mb-0" data-primary="green-400" data-rounded="rounded-2xl" data-primary-reset="{}">
                        Shop Now
